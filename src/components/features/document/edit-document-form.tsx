...
export function EditDocumentForm({onClose,onUpdate,categories,tags,onCreateCategory,onCreateTag,onDeleteCategory,onDeleteTag,initial}:EditDocumentFormProps){
